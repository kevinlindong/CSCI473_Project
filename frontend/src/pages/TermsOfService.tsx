...
const sections = [
  {
    ...
    body: [
      'By accessing or using Scholar ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.',
  ...
  },
  {
    ...
    body: [
      'You retain ownership of any notes, documents, or other content ("User Content") you create or upload to Scholar. By posting User Content, you grant Scholar a non-exclusive, worldwide, royalty-free licence to store, display, and process your content solely for the purpose of operating and improving the Service.',
  ...
  },
  {
    ...
    body: [
      ...
      'Academic integrity is core to our mission. You agree not to use Scholar to facilitate academic dishonesty, including submitting AI-generated or collaboratively produced content as solely your own in violation of your institution\'s honour code.',
  ...
  },
  {
    ...
    title: 'AI Features',
    body: [
      'Scholar uses AI models to provide features such as note merging, flashcard generation, and content summarisation. AI-generated output is provided "as-is" and may contain errors. You are responsible for reviewing AI output before relying on it for academic or professional purposes.',
      'By using AI features, you grant Scholar permission to process your content through these models. We do not sell your content to third-party AI providers, and processing is performed solely to deliver the requested feature.',
    ],
  },
  {
    number: '06',
    ...
    body: [
      'The Scholar name, logo, interface, and underlying software are the intellectual property of Scholar and its creators. You may not copy, modify, distribute, or create derivative works from any part of the Service without express written permission.',
      'All rights not expressly granted in these Terms are reserved by Scholar.',
    ],
  },
  {
    number: '07',
    title: 'Disclaimers',
    body: [
      'The Service is provided "as is" and "as available" without warranties of any kind, either express or implied. Scholar does not warrant that the Service will be uninterrupted, error-free, or free of viruses or other harmful components.',
  ...
  },
  {
    ...
    body: [
      'To the fullest extent permitted by law, Scholar and its creators shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of the Service, even if we have been advised of the possibility of such damages.',
  ...
  },
  {
    ...
    title: 'Contact',
    body: [
      'If you have questions about these Terms, please reach out to us at legal@scholar.app. We aim to respond to all inquiries within five business days.',
    ],
  },
]
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <section className="max-w-3xl mx-auto px-6 pt-16 pb-10 stagger">
          ...
          <p className="font-[family-name:var(--font-body)] text-sm text-forest/45 leading-relaxed">
            Last updated <span className="text-forest/60">{LAST_UPDATED}</span>. These terms govern your use of Scholar. Please read them carefully.
          </p>
        </section>
        ...
        <div className="max-w-3xl mx-auto px-6 pb-24 space-y-8">
          ...
          <p className="font-mono text-[10px] text-forest/25 text-center pt-4">
            Scholar · {LAST_UPDATED} · <Link to="/privacy" className="hover:text-forest/40 transition-colors underline">Privacy Policy</Link>
          </p>
        </div>
      </div>
